...
class CircleTile: SKSpriteNode, GameTile {
    var number : Int32
    ...
    let highlight = SKSpriteNode(imageNamed: "CircleHighlight.png")
    let white = SKSpriteNode(imageNamed: "CircleWhite.png")
    var numConflicts = 0
    var prepped = false
    var prepping = false
    ...
    required init(gameScene: GameScene, number: Int32, angle: CGFloat) {
        ...
        let texture = SKTexture(imageNamed: "Circle.png")
        ...
        edgeDist = self.size.width*0.485*2.7/self.xScale
        bottomDist = self.size.width*0.485*2.7/self.xScale
    ...
    func turnRed() {
        self.texture = SKTexture(imageNamed: "CircleRed.png")
    }
    
    func turnBlack() {
        self.texture = SKTexture(imageNamed: "Circle.png")
    }
